...
本目录收纳与 AI coding workflow、需求到实现流程、外部工具链组合相关的对标材料。
...
- [spec-brainstorm 能力升级方案](./spec-brainstorm-能力升级方案.md)

## 关注问题

- 外部 workflow 如何约束需求澄清、计划生成、执行和复盘。
- 哪些流程纪律适合被 spec-first 吸收，哪些会变成过重的中心化状态机。
- brainstorm / PRD / plan / work 之间的交接机制如何降低返工。
