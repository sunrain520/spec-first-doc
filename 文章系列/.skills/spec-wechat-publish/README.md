...
```text
使用 文章系列/.skills/spec-wechat-publish/SKILL.md，发布 文章系列/第一季-harness认知/02-ai-coding-harness.md
```
...
- 它是 `文章系列/` 的运营资产，固定放在 `文章系列/.skills/spec-wechat-publish/`，不要移到仓库根目录或其他 skill 目录。
