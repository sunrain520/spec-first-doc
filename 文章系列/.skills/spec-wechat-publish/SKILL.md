...
**执行：** 对照 playbook 末尾「运营质量检查清单」逐条核，重点七项：

1. **标题**：冒号后是读者痛点/收益，不是作者成就？（`Spec-First：` 前缀已由 4.7 保证）
2. **首屏**：痛点故事开场，不是「导读+专名」劝退新读者？
3. **情感弹药**：画面感故事/翻车现场在开头出现过，没全囤在结尾？
4. **结尾 CTA 三件套**：关注引导 + 转发钩子 + 阅读原文话术 + 下一篇预告齐全？
5. **传播资产**：有可截图的全景图/核心对比表/金句？
6. **受众**：本篇锁定一类主受众，没同时服务三类？
7. **金句**：加粗金句可独立传播（脱离上下文仍有力）？
...
- **运营质量 playbook（Step 4.7 标题运营 + Step 6.6 运营检查用）**：[references/operations-playbook.md](references/operations-playbook.md)（标题钩子/开篇四步/CTA 三件套/打开率·完读率·转化·传播原则/读者分层；完整经验见 `docs/solutions/conventions/wechat-article-operations-playbook-2026-06-15.md`）
