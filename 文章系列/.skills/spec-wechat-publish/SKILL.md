...
**SKILL_DIR 约定：** 执行本 skill 时，`SKILL_DIR` 指本 SKILL.md 所在目录（`文章系列/.skills/spec-wechat-publish/`）。
...
**输出：** `文章系列/pic/{slug}-cover.png`（900×383px）
...
- 文章系列目录：`文章系列/`
- 内容路线图：`文章系列/运营规划/2026-05-27-004-spec-first-wechat-series-content-roadmap.md`
