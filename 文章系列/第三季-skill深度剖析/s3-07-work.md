...
description: spec-first 微信公众号第三季第 7 篇：work 不是"让 AI 自由发挥"，而是在 plan 边界内的受控执行。五个关键控制点：scope 验证、task identity、vertical tracer bullet、review gate、handoff evidence。
metadata:
  type: article
  series: s2
  series_index: "s3-07"
