---
name: s3-09-code-review
title: Spec-First：AI review 了半天，上线还是出了问题——为什么
description: spec-first 微信公众号第三季第 9 篇：review 需要角色、证据、影响面、降级和 residual risk。"你再检查一下"没有 severity、没有 evidence、没有 owner、没有 verification，不是 review contract。
metadata:
  type: article
  series: s2
  series_index: "s3-09"
